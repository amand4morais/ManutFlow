...
def listar_manutencoes():
    ...
    # Processa as datas se fornecidas (Da Main)
    if data_inicio_str:
        try:
...
def nova_manutencao():
    """
    Cadastra uma nova manutenção (União Main + Branch)
    """
    ...
    if request.method == 'POST':
        try:
            ...
            # Cria nova manutenção (Com autor_id da Branch)
...
def deletar_manutencao(manutencao_id):
    """
    Deleta uma manutenção (Segurança da Branch)
    """
